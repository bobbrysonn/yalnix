...
\title{Yalnix Checkpoints 1 \& 2 Pseudocode}
\author{COSC 58}
\date{\today}
...
\begin{itemize}[noitemsep]
  ...
  \item \texttt{Queue.c}, \texttt{Queue.h}: queue helpers for ready and blocked queues.
  \item \texttt{kernelbrk.c}: kernel heap break management.
  \item \texttt{template.c}: future \texttt{LoadProgram}.
\end{itemize}
...
\section{Upcoming Checkpoint 3}

The current \texttt{LoadProgram} file is a stub. The planned flow is:
